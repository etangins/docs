...
<Frame>
  ```mermaid
  graph TD
    J1[Judge v1] --> R1[Router v1]
    J1 --> R2[Router v2]
    J2[Judge v2] --> R3[Router v3]
    J2 --> R4[Router v4]
    
    style J1 fill:#b5d3e7
    style J2 fill:#b5d3e7
    style R1 fill:#d4e6c3
    style R2 fill:#d4e6c3
    style R3 fill:#d4e6c3
    style R4 fill:#d4e6c3
  ```
</Frame>
