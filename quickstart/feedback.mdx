...
def add_feedback(router_request, router_response, score, rationale=None):
    url = f'{API_URL}/org/{ORG_ID}/routers/{ROUTER_ID}/versions/{ROUTER_VERSION}/judgement'
    score = score + 1 # rescaling to the judge range
    data = {
...
if __name__ == "__main__":
    while True:
        ...
        add_feedback(translation_request, translation_response, score)
```
