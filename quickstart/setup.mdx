...
<Steps>
  <Step title="Sign In">
    Go to [develop.withmartian.com/workbench](https://develop.withmartian.com/dashboard) or whatever URL you normally access your user dashboard from.
  </Step>
...
2. Replace the base\_url parameters
...
4. Test to make sure it is working
Run the translator:
